...
class SearchController extends Controller{
    public function qidruv_muxir(){
        $Muxir = Muxir::where('muxirs.status','true')
            ...
            ->select('muxirs.number','muxirs.faktura','muxir_fakturas.coato','muxir_fakturas.coato_name','muxir_fakturas.hodim','muxir_fakturas.operator','muxir_fakturas.created_at')
            ->get();
    ...
    public function qidruv_naryad_blanka(){
        $Muxir = NaryadB::where('naryad_b_s.status','true')
            ...
            ->select('naryad_b_s.number','naryad_b_s.faktura','naryad_blanka_fakturas.coato','naryad_blanka_fakturas.coato_name','naryad_blanka_fakturas.hodim','naryad_blanka_fakturas.operator','naryad_blanka_fakturas.created_at')
            ->get();
