...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Naryadlar(Blanka)</li>
    </ol>
  </nav>
</div>
...
@endif
<div class="row mb-3">
  <div class="col-3"><a href="{{ route('qidruv_muxir') }}" class="btn btn-secondary w-100">Muxirlar</a></div>
  <div class="col-3"><a href="{{ ROUTE('qidruv_naryad_blanka') }}" class="btn btn-primary w-100">Naryad (blanka)</a></div>
