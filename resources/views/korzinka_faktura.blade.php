...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item active">Qayd varaqasi</li>
    </ol>
  </nav>
</div>
...
<section class="section dashboard">
  ...
  <div class="card">
    <div class="card-body">
      <h4 class="card-title w-100 text-center">Tasdiqlangan scanner nushasini yuklash (jpg, pdf)</h4>
      <form action="{{ route('korzinka_faktura_image') }}" method="post" class="text-center" enctype="multipart/form-data">
        @csrf 
