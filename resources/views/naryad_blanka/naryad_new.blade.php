...
@section('title',"Yangi naryad blanka")
@section('content')
...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Yangi naryad(blanka)</li>
    </ol>
  </nav>
</div>
<div class="row mb-3">
<div class="col-3"><a href="{{ route('naryad_blanka') }}" class="btn btn-secondary w-100">Mavjud naryad (blanka)</a></div>
  ...
  <div class="col-3"><a href="{{ ROUTE('naryad_blanka_NEW') }}" class="btn btn-primary w-100">Yangi naryad (blanka)</a></div>
...
<section class="section dashboard">
  <div class="card recent-sales overflow-auto">
    <div class="card-body">   
      <form action="{{ route('naryad_blanka_NEW_story') }}" method="post">
        @csrf 
        <h4 class="card-title w-100 text-center">Yangi naryad blankasi kiritish</h4>
        <div class="row">
          <div class="col-8">
